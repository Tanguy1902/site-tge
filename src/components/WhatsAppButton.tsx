...
const WHATSAPP_NUMBER = CONTACT_INFO.whatsapp.replace(/\s/g, "").replace("+", "");
const WHATSAPP_MESSAGE = encodeURIComponent(
  "Bonjour ! Je suis intéressé(e) par l'expédition Tsiribihina Green Expedition. Pouvez-vous m'envoyer plus d'informations ?"
);
      ...
      <AnimatePresence>
        {isTooltipVisible && (
          <motion.div
            ...
            className="relative bg-white rounded-2xl shadow-xl px-4 py-3 max-w-[220px] border border-gray-100"
          >
            <button
